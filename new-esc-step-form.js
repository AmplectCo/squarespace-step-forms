(function stepForms() {
    ...
    const SUBMIT_FORM_API_URL = 'https://euro-sports-camps.squarespace.com/api/commerce/shopping-cart/entries';
    const VALIDATE_FORM_API_URL = 'https://euro-sports-camps.squarespace.com/api/rest/forms/validate';
    const CART_URL = 'https://euro-sports-camps.squarespace.com/cart';
    const SUBMIT_TEMP_FORM_API_URL = urlParams.get("test") !== null ? "https://gx8576lr41.execute-api.us-east-1.amazonaws.com/dev/" : 'https://mgr8cnbvn9.execute-api.us-east-1.amazonaws.com/dev';

    const AGE_NOT_ALLOWED_ERROR_TEXT = 'This player does not meet the age requirements for this camp';
